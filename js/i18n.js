var i18n = {
	en:{
		...
		mediumIntensity:'Moderate rain',
		highIntensity:'Heavy rain',
		lowSnow:'Light snow',
		mediumSnow:'Moderate snow',
		highSnow:'Heavy snow',
		measurementNote:'Disclaimer: RWIS data here provided refer to indicated locations only and are not representative of the road segment conditions in between',
